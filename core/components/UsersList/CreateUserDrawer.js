    ...
    >
        <Row gutter={24}>
          ...
          <Col span={12}>
            <Form.Item
              name="confirm_email"
	      label={formatMessage({ id: 'core.confirm_email_address', defaultMessage: 'Confirm email' })}
              dependencies={['email']}
              hasFeedback
              rules={[
                {
	      ...
	      label={formatMessage({ id: 'core.Confirm_password', defaultMessage: 'Confirm password' })}
