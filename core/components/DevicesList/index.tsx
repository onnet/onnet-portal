...
import CreateUser from '../UsersList/CreateUser';
import EditUser from '../UsersList/EditUser';
import UserParagraph from '../UsersList/UserParagraph';
import UserPrivLevel from '../UsersList/UserPrivLevel';
      ...
      <Drawer
        title={
          full_users[selectedUser] ? (
            <span>
              {formatMessage({ id: 'core.Edit_device', defaultMessage: 'Edit device' })}
